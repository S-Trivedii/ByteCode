...
const HeroSection = () => {
  return (
    <section className="relative min-h-[600px] w-full overflow-hidden bg-gradient-to-br from-purple-950 via-indigo-950 to-indigo-950">
      ...
      <div className="container relative mx-auto flex h-full flex-col items-center justify-center px-4 md:px-8 lg:px-16 py-24 md:flex-row md:py-32">
        {/* Content */}
        <div className="flex-1 space-y-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row md:justify-start">
            <Button
              size="lg"
              className="rounded-full px-8 py-6 text-md text-white bg-black cursor-pointer"
            >
              Start Reading
            </Button>
            <Button
              variant="outline"
              size="lg"
              className="rounded-full px-8 py-6 text-md bg-white dark:text-white cursor-pointer"
            >
              Explore Topics
            </Button>
          </div>
        ...
        <div className="mt-12 flex-1 md:mt-0">
          <div
            className={cn(
              "relative mx-4 md:mx-auto h-64 w-64 rounded-2xl overflow-hidden",
